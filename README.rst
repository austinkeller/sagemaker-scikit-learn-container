...
Tagging scheme is based on <Scikit-learn_version>-cpu-py<python_version>. (e.g. 0.22.2.post1-cpu-py3)
...
::
    ...
    # CPU
    docker build -t sklearn-base:0.22.2.post1-cpu-py3 -f docker/0.22.2.post1/base/Dockerfile.cpu --build-arg py_version=3 .
...
::
    ...
    # CPU
    docker build -t preprod-sklearn:0.22.2.post1-cpu-py3 -f docker/0.22.2.post1/final/Dockerfile.cpu --build-arg py_version=3 .
...
::
    ...
    pytest test/integration/local --docker-base-name preprod-sklearn \
                      --tag 1.0 \
                      --py-version 3 \
                      --framework-version 0.22.2.post1
